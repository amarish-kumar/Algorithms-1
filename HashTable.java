...
When he enters the class he will give you the roll number of any of his colleagues belonging to the class. You need to revert to him with the name of that colleague.
...
class HashTable {
    public static void main(String args[] ) throws Exception {
        ...
        for(int i = 0;i<q;i++){
            ...
            System.out.println((String)hashtable.get(roll));
        }
    }
}
